...
<table border="1" style="width:500px">
	...
	<tr>
		<th>고객 이름</th>
		<td><input type="text" id="csName" name="csName" size="25"> <span class="errorMessage"><form:errors path="customer.csName"/></span></td>
	</tr>
	<tr>
		<th>고객 Email</th>
		<td><input type="text" id="csEmail" name="csEmail" size="25"> <span class="errorMessage"><form:errors path="customer.csEmail"/></span></td>
	</tr>
	<tr>
		<th>고객 번호</th>
		<td><input type="text" id="csPhone" name="csPhone" size="25"> <span class="errorMessage"><form:errors path="customer.csPhone"/></span></td>
	</tr>
	<tr>
		<td colspan="2">
